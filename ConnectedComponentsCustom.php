 ...
 */
class ConnectedComponentsCustom extends BaseGraph
{
    private $follow_dir = 0;
     ...
     */
    public function createGraphComponentVertex(Vertex $vertex, $dir = 0, $max_depth = PHP_INT_MAX)
    {
        ...
        return $this->graph->createGraphCloneVertices($this->createSearch($vertex)->getVertices($max_depth));
    }
    ...
    private function createSearch(Vertex $vertex)
    {
        ...
        switch ($this->follow_dir) {
            case 1:
                return $alg->setDirection(SearchBreadthFirst::DIRECTION_FORWARD);
                break;
            case 2:
                return $alg->setDirection(SearchBreadthFirst::DIRECTION_REVERSE);
                break;
            default:
